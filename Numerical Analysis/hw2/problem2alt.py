...
def strassen(m1,m2, level):
    ...
    if l == 2:
        ...
        p1 = strassen(a11, sub_mats(b12,b22),level+1)
        p2 = strassen(add_mats(a11,a12),b22,level+1)
        p3 = strassen(add_mats(a21,a22),b11,level+1)
        p4 = strassen(a22,sub_mats(b21,b11),level+1)
        p5 = strassen(add_mats(a11,a22),add_mats(b11,b22),level+1)
        p6 = strassen(sub_mats(a12,a22),add_mats(b21,b22),level+1)
        p7 = strassen(sub_mats(a11,a21),add_mats(b11,b12),level+1)
...
#econd_matrix = [[random.uniform(-1,1) for i in range(1024)] for j in range(1024)]


#print(strassen(first_matrix,second_matrix,0))
...
print(strassen(first_matrix_bigger,second_matrix_bigger,0))
